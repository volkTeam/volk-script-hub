const SUPABASE_URL = 'https://yrclsymsijfkfbjjqegun.supabase.co'; 
...
const ADMIN_EMAILS = ['natalikalashnik180789@gmail.com']; // Впишите сюда свой реальный email администратора
...
async function verifyEmailCode() {
  ...
  if (!pendingEmail) return alert('Email not found. Please try signing up again.');
...
async function loadStats() {
  try {
    ...
    // Если RPC функция не создана в Supabase, игнорируем ошибку
  }
